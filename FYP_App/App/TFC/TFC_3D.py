...
def TrainModel(l, points=100, poly_order=30, poly_removed=2, basis_func='CP', method="pinv", plot=True, save_orbit=False, run_type='TFC', inputs={}):
    ...
    with col2:
        ...
        st.markdown(f'<p style="text-align:left;color:#00cf22 ;font-size:20px;border-radius:0%;"> \
                            ...
                            error = {norm([vel_error_x, vel_error_y, vel_error_z]):.10f}%  \
                            </p>', unsafe_allow_html=True)
...
def train_models(l, points=[51], poly_orders=[50], poly_removes=[2], basis_funcs=['LeP'], methods = ["pinv"], plot=False, save_orbit=False, run_type='TFC', inputs={}):
    data = []
